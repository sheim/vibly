...
p = {'mass': 80,                          # kg
     ...
     'linear_normalized_dampin': 3.5,  # * A: s/m : D/F : [N/m/s]/N : 0.0035 N/mm/s -> 3.5 1/m/s from Kirch et al. Fig 12
...
s_grid_height = np.linspace(0.5, 1.5, 18)#185)
s_grid_velocity = np.linspace(3, 6, 15)#61)
s_grid = (s_grid_height, s_grid_velocity)
a_grid = (np.linspace(00/180*np.pi, 70/180*np.pi, 71),)#141), )
