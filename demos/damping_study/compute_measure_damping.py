...
# * WARNING: this can take a very long time. The pre-computed data generated by
# * this script is provide in vibly/data/guineafowl/
...
def compute_viability(x0, p, name, visualise=False):
    ...
    # * in this case the relevant states at apex: (y, xdot) (height, velocity)
    ...
    # * seem to be much qualitative difference in the results for the
    # * nominal limit-cycle used in the paper. For other conditions, it may
    # * be important to include this in the model.
