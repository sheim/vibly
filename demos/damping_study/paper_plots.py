...
set_files = [
    "../../data/guineafowl/guineafowl_0.0010.pickle",
...
traj_files = [
    "../../data/guineafowl/guineafowl_0.0010_trajs.pickle",
    "../../data/guineafowl/guineafowl_0.0050_trajs.pickle",
    "../../data/guineafowl/guineafowl_0.0100_trajs.pickle",
    "../../data/guineafowl/guineafowl_0.0200_trajs.pickle",
    "../../data/guineafowl/guineafowl_0.0300_trajs.pickle",
    "../../data/guineafowl/guineafowl_0.0400_trajs.pickle",
    "../../data/guineafowl/guineafowl_0.0500_trajs.pickle",
    "../../data/guineafowl/guineafowl_0.0600_trajs.pickle",
    "../../data/guineafowl/guineafowl_0.0700_trajs.pickle",
    "../../data/guineafowl/guineafowl_0.0800_trajs.pickle",
    "../../data/guineafowl/guineafowl_0.0900_trajs.pickle",
    "../../data/guineafowl/guineafowl_0.1000_trajs.pickle",
    "../../data/guineafowl/guineafowl_0.1100_trajs.pickle",
    "../../data/guineafowl/guineafowl_0.1200_trajs.pickle",
    "../../data/guineafowl/guineafowl_0.1300_trajs.pickle",
    "../../data/guineafowl/guineafowl_0.1400_trajs.pickle",
    "../../data/guineafowl/guineafowl_0.1500_trajs.pickle",
    "../../data/guineafowl/guineafowl_0.1600_trajs.pickle",
    "../../data/guineafowl/guineafowl_0.1700_trajs.pickle",
    "../../data/guineafowl/guineafowl_0.1800_trajs.pickle",
    "../../data/guineafowl/guineafowl_0.1900_trajs.pickle",
]
...
damping_values = np.array(
    [d["p"]["constant_normalized_damping"] * d["p"]["stiffness"] for d in data_list]
)
...
if WATERFALL_PLOT:
    ...
    if FILTER:
        ...
        for ydx in range(len(y)):
            ...
            # we want the window to round off,
            # so it doesn't smooth over the edge.
    ...
    ax.set_yticklabels(
        ["  {:.1f}".format(x / norm_damping) for x in ytickers], va="center", ha="left"
    )
    ...
    ax.set_zticklabels(["  {:.0f}".format(x) for x in ztickers * 60], va="center")
    ax.zaxis.labelpad = 30
    # ax.tick_params(axis='both', which='major', length=0)
    ax.view_init(elev=42.0, azim=-83)
...
if TRAJ_PLOTS:
    ...
    my_ytick_labels = np.round(
        my_yticks / leg_length, decimals=1
    )  # ticks normalized by hip height
    ...
    for idx in plot_these:
        ...
        fig, ax = plt.subplots()
        daplot.plot_ground_perturbations(
            ax,
            trajec_list[idx],
            data_list[idx]["S_M"],
            data_list[idx]["grids"],
...
if POINC_PLOT:
    ...
    for i, data in enumerate(data_list[i] for i in plot_these):
        ...
        daplot.poincare_plot(
            fig, ax, data, vmax=vmax, trajectories=trajec_list[i], min_M=0.0
        )
        plt.show()
