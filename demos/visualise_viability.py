...
def visualise_visibility(data, include_end_state = False, initial_conditions = []):
...
visualise_visibility(data)
visualise_visibility(data, initial_conditions = initial_conditions)
visualise_visibility(data, include_end_state = True, initial_conditions = initial_conditions)