...
# see = True      		: calls up show() within the animation_visualisation function;
# I don't know why but if you call show here, you don't see the animation
# save = False    		: saves the animation
# writer_name = 'html'	: default html files, 'pillow' writes gif, 'ffmpeg' writes mp4
