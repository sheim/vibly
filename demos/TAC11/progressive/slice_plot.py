...
mynorm = colors.TwoSlopeNorm(vmin=v_min, vcenter=0., vmax=v_max)
...
# axs[1].set_xlim((-4., 4.))
collection = collections.BrokenBarHCollection.span_where(x1_slice, ymin=v_min,
                    ymax=v_max, where= ~XV_slice, facecolor='red', alpha=0.2)
