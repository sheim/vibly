...
def L2wacky(s, a):
    r1 = np.hypot(s0_weight * (s[0] - 4.0), s1_weight * (s[1] + 4.0))
...
reward_functions = (L2wacky, penalty)
savename = "./wacky"
...
# failure_penalties = [5., 10., 25., 50.]
# failure_penalties = [0., 1.,1e2, 1e3, 125., 150., 175., 200.]
failure_penalties = np.arange(125.0, 150.0, 1.0)
