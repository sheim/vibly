...
def run_demo(
    ...
    sampler.init_estimation(
        seed_data=seed_data, prior_model_path=gp_model_file, learn_hyperparameters=False
    )

    sampler.exploration_confidence_s = 0.95
    sampler.exploration_confidence_e = 0.9999
    sampler.measure_confidence_s = 0.75
    sampler.measure_confidence_e = 0.9999
    ...
    plot_callback = cplot.create_plot_callback(
        n_samples,
